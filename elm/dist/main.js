...
var _user$project$ImageCrop$calculateCropArea = F2(
	function (image, cropAreaWidth) {
		return {
			width: cropAreaWidth,
			height: _elm_lang$core$Basics$round(
				(_elm_lang$core$Basics$toFloat(image.height) / _elm_lang$core$Basics$toFloat(image.width)) * _elm_lang$core$Basics$toFloat(cropAreaWidth))
		};
	});
var _user$project$ImageCrop$scalePoint = F2(
	function (factor, point) {
		return {
			x: _elm_lang$core$Basics$round(
				_elm_lang$core$Basics$toFloat(point.x) * factor),
			y: _elm_lang$core$Basics$round(
				_elm_lang$core$Basics$toFloat(point.y) * factor)
		};
	});
var _user$project$ImageCrop$scaleRectangle = F2(
	function (factor, rectangle) {
		return {
			topLeft: A2(_user$project$ImageCrop$scalePoint, factor, rectangle.topLeft),
			bottomRight: A2(_user$project$ImageCrop$scalePoint, factor, rectangle.bottomRight)
		};
	});
var _user$project$ImageCrop$rectangleSize = function (_p0) {
	var _p1 = _p0;
	var _p3 = _p1.topLeft;
	var _p2 = _p1.bottomRight;
	return {width: _p2.x - _p3.x, height: _p2.y - _p3.y};
};
var _user$project$ImageCrop$rectangleArea = function (rectangle) {
	var size = _user$project$ImageCrop$rectangleSize(rectangle);
	return size.width * size.height;
};
var _user$project$ImageCrop$selectionStyle = function (displaySelection) {
	var _p4 = _user$project$ImageCrop$rectangleSize(displaySelection);
	var width = _p4.width;
	var height = _p4.height;
	var _p5 = displaySelection.topLeft;
	var x = _p5.x;
	var y = _p5.y;
	return _elm_lang$html$Html_Attributes$style(
		{
			...
			_1: {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'left',
					_1: _user$project$ImageCrop$px(x)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'top',
						_1: _user$project$ImageCrop$px(y)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'width',
							_1: _user$project$ImageCrop$px(width)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'height',
								_1: _user$project$ImageCrop$px(height)
							},
							_1: {
								ctor: '::',
...
var _user$project$ImageCrop$orderEdges = F2(
	function (first, second) {
		return {
			topLeft: {
				x: A2(_elm_lang$core$Basics$min, first.x, second.x),
				y: A2(_elm_lang$core$Basics$min, first.y, second.y)
			},
			bottomRight: {
				x: A2(_elm_lang$core$Basics$max, first.x, second.x),
				y: A2(_elm_lang$core$Basics$max, first.y, second.y)
			}
		};
	});
var _user$project$ImageCrop$heightFromWidth = F2(
	function (aspectRatio, width) {
		return _elm_lang$core$Basics$round(
			(_elm_lang$core$Basics$toFloat(width) / aspectRatio.width) * aspectRatio.height);
	});
var _user$project$ImageCrop$widthFromHeight = F2(
	function (aspectRatio, height) {
		return _elm_lang$core$Basics$round(
			(_elm_lang$core$Basics$toFloat(height) / aspectRatio.height) * aspectRatio.width);
	});
var _user$project$ImageCrop$maxBy = F3(
	function (fn, a, b) {
		return (_elm_lang$core$Native_Utils.cmp(
			fn(b),
			fn(a)) > 0) ? b : a;
	});
var _user$project$ImageCrop$minBy = F3(
	function (fn, a, b) {
		return (_elm_lang$core$Native_Utils.cmp(
			fn(b),
			fn(a)) < 0) ? b : a;
	});
var _user$project$ImageCrop$createMaxRectangles = F5(
	function (generalDirection, image, aspectRatio, anchor, position) {
		var _p6 = generalDirection;
		switch (_p6.ctor) {
			case 'HorizontalDirection':
				var bottomBoundaryRectangle = function () {
					var factor = (_elm_lang$core$Native_Utils.cmp(position.x, anchor.x) < 0) ? -1 : 1;
					var height = (image.height - anchor.y) * 2;
					var width = factor * A2(_user$project$ImageCrop$widthFromHeight, aspectRatio, height);
					var second = {x: anchor.x + width, y: image.height};
					var first = {x: anchor.x, y: image.height - height};
					return A2(_user$project$ImageCrop$orderEdges, first, second);
				}();
				var topBoundaryRectangle = function () {
					var first = {x: anchor.x, y: 0};
					var factor = (_elm_lang$core$Native_Utils.cmp(position.x, anchor.x) < 0) ? -1 : 1;
					var height = anchor.y * 2;
					var width = factor * A2(_user$project$ImageCrop$widthFromHeight, aspectRatio, height);
					var second = {x: anchor.x + width, y: height};
					return A2(_user$project$ImageCrop$orderEdges, first, second);
				}();
				return {
					ctor: '::',
					_0: topBoundaryRectangle,
					_1: {
						ctor: '::',
						_0: bottomBoundaryRectangle,
						_1: {ctor: '[]'}
					}
				};
			case 'VerticalDirection':
				var rightBoundaryRectangle = function () {
					var factor = (_elm_lang$core$Native_Utils.cmp(position.y, anchor.y) < 0) ? -1 : 1;
					var width = (image.width - anchor.x) * 2;
					var height = factor * A2(_user$project$ImageCrop$heightFromWidth, aspectRatio, width);
					var second = {x: image.width, y: anchor.y + height};
					var first = {x: image.width - width, y: anchor.y};
					return A2(_user$project$ImageCrop$orderEdges, first, second);
				}();
				var leftBoundaryRectangle = function () {
					var first = {x: 0, y: anchor.y};
					var factor = (_elm_lang$core$Native_Utils.cmp(position.y, anchor.y) < 0) ? -1 : 1;
					var width = anchor.x * 2;
					var height = factor * A2(_user$project$ImageCrop$heightFromWidth, aspectRatio, width);
					var second = {x: width, y: anchor.y + height};
					return A2(_user$project$ImageCrop$orderEdges, first, second);
				}();
				return {
					ctor: '::',
					_0: leftBoundaryRectangle,
					_1: {
						ctor: '::',
						_0: rightBoundaryRectangle,
						_1: {ctor: '[]'}
					}
				};
			default:
				var verticalBoundary = function () {
					var factor = (_elm_lang$core$Native_Utils.cmp(position.x, anchor.x) < 0) ? -1 : 1;
					var boundaryValue = (_elm_lang$core$Native_Utils.cmp(position.y, anchor.y) < 0) ? 0 : image.height;
					var height = _elm_lang$core$Basics$abs(boundaryValue - anchor.y);
					var width = factor * A2(_user$project$ImageCrop$widthFromHeight, aspectRatio, height);
					var target = {x: anchor.x + width, y: boundaryValue};
					return A2(_user$project$ImageCrop$orderEdges, anchor, target);
				}();
				var horizontalBoundary = function () {
					var factor = (_elm_lang$core$Native_Utils.cmp(position.y, anchor.y) < 0) ? -1 : 1;
					var boundaryValue = (_elm_lang$core$Native_Utils.cmp(position.x, anchor.x) < 0) ? 0 : image.width;
					var width = _elm_lang$core$Basics$abs(boundaryValue - anchor.x);
					var height = factor * A2(_user$project$ImageCrop$heightFromWidth, aspectRatio, width);
					var target = {x: boundaryValue, y: anchor.y + height};
					return A2(_user$project$ImageCrop$orderEdges, anchor, target);
				}();
				return {
					ctor: '::',
					_0: horizontalBoundary,
					_1: {
						ctor: '::',
						_0: verticalBoundary,
						_1: {ctor: '[]'}
...
var _user$project$ImageCrop$createSelectionFromMouse = F4(
	function (image, aspectRatio, anchor, position) {
		var verticallyAlignedRectangle = function () {
			var factor = (_elm_lang$core$Native_Utils.cmp(position.x, anchor.x) < 0) ? -1 : 1;
			var height = _elm_lang$core$Basics$abs(position.y - anchor.y);
			var width = factor * A2(_user$project$ImageCrop$widthFromHeight, aspectRatio, height);
			var target = {x: anchor.x + width, y: position.y};
			return A2(_user$project$ImageCrop$orderEdges, anchor, target);
		}();
		var horizontallyAlignedRectangle = function () {
			var factor = (_elm_lang$core$Native_Utils.cmp(position.y, anchor.y) < 0) ? -1 : 1;
			var width = _elm_lang$core$Basics$abs(position.x - anchor.x);
			var height = factor * A2(_user$project$ImageCrop$heightFromWidth, aspectRatio, width);
			var target = {x: position.x, y: anchor.y + height};
			return A2(_user$project$ImageCrop$orderEdges, anchor, target);
		}();
		return A3(_user$project$ImageCrop$maxBy, _user$project$ImageCrop$rectangleArea, horizontallyAlignedRectangle, verticallyAlignedRectangle);
	});
var _user$project$ImageCrop$movePoint = F2(
	function (movement, point) {
		return {x: point.x + movement.horizontal, y: point.y + movement.vertical};
	});
var _user$project$ImageCrop$moveRectangle = F2(
	function (movement, rectangle) {
		return {
			topLeft: A2(_user$project$ImageCrop$movePoint, movement, rectangle.topLeft),
			bottomRight: A2(_user$project$ImageCrop$movePoint, movement, rectangle.bottomRight)
		};
	});
var _user$project$ImageCrop$atMost = _elm_lang$core$Basics$min;
var _user$project$ImageCrop$atLeast = _elm_lang$core$Basics$max;
var _user$project$ImageCrop$moveSelection = F4(
	function (image, cropAreaWidth, move, current) {
		var factor = _elm_lang$core$Basics$toFloat(image.width) / _elm_lang$core$Basics$toFloat(cropAreaWidth);
		var scale = function (value) {
			return _elm_lang$core$Basics$round(
				_elm_lang$core$Basics$toFloat(value) * factor);
		};
		var selection = move.originalSelection;
		var movement = {
			horizontal: A2(
				_user$project$ImageCrop$atMost,
				image.width - selection.bottomRight.x,
				A2(
					_user$project$ImageCrop$atLeast,
					0 - selection.topLeft.x,
					scale(current.x - move.start.x))),
			vertical: A2(
				_user$project$ImageCrop$atMost,
				image.height - selection.bottomRight.y,
				A2(
					_user$project$ImageCrop$atLeast,
					0 - selection.topLeft.y,
					scale(current.y - move.start.y)))
		};
		return A2(_user$project$ImageCrop$moveRectangle, movement, move.originalSelection);
	});
var _user$project$ImageCrop$normalizeEdges = F3(
	function (canvas, first, second) {
		var ordered = A2(_user$project$ImageCrop$orderEdges, first, second);
		return {
			topLeft: {
				x: A2(_user$project$ImageCrop$atLeast, 0, ordered.topLeft.x),
				y: A2(_user$project$ImageCrop$atLeast, 0, ordered.topLeft.y)
			},
			bottomRight: {
				x: A2(_user$project$ImageCrop$atMost, canvas.width, ordered.bottomRight.x),
				y: A2(_user$project$ImageCrop$atMost, canvas.height, ordered.bottomRight.y)
			}
		};
	});
var _user$project$ImageCrop$createResizeRectangleFromMouse = F5(
	function (image, generalDirection, aspectRatio, anchor, position) {
		var _p7 = generalDirection;
		switch (_p7.ctor) {
			case 'HorizontalDirection':
				var x = A2(
					_user$project$ImageCrop$atMost,
					image.width,
					A2(_user$project$ImageCrop$atLeast, 0, position.x));
				var width = _elm_lang$core$Basics$abs(x - anchor.x);
				var height = A2(_user$project$ImageCrop$heightFromWidth, aspectRatio, width);
				var first = {
					x: anchor.x,
					y: anchor.y - _elm_lang$core$Basics$round(
			...
			case 'VerticalDirection':
				var y = A2(
					_user$project$ImageCrop$atMost,
					image.height,
					A2(_user$project$ImageCrop$atLeast, 0, position.y));
				var height = _elm_lang$core$Basics$abs(y - anchor.y);
				var width = A2(_user$project$ImageCrop$widthFromHeight, aspectRatio, height);
				var first = {
					x: anchor.x - _elm_lang$core$Basics$round(
				...
				return A2(_user$project$ImageCrop$orderEdges, first, second);
			default:
				return A4(_user$project$ImageCrop$createSelectionFromMouse, image, aspectRatio, anchor, position);
		}
	});
var _user$project$ImageCrop$createAspectRatioSelection = F5(
	function (image, aspectRatio, generalDirection, anchor, position) {
		var edgeConstraints = A5(_user$project$ImageCrop$createMaxRectangles, generalDirection, image, aspectRatio, anchor, position);
		var mouseRectangle = A5(_user$project$ImageCrop$createResizeRectangleFromMouse, image, generalDirection, aspectRatio, anchor, position);
		return A3(
			_elm_lang$core$List$foldr,
			_user$project$ImageCrop$minBy(_user$project$ImageCrop$rectangleArea),
			mouseRectangle,
			edgeConstraints);
	});
...
var _user$project$ImageCrop$Rectangle = F2(
	function (a, b) {
		return {topLeft: a, bottomRight: b};
	});
var _user$project$ImageCrop$Movement = F2(
	function (a, b) {
...
var _user$project$ImageCrop$MouseButtonEvent = F2(
	function (a, b) {
		return {position: a, button: b};
	});
var _user$project$ImageCrop$mouseEventDecoder = A4(
	_elm_lang$core$Json_Decode$map3,
	F3(
		function (x, y, button) {
			return A2(
				_user$project$ImageCrop$MouseButtonEvent,
				A2(_elm_lang$mouse$Mouse$Position, x, y),
				button);
		}),
	A2(_elm_lang$core$Json_Decode$field, 'pageX', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'pageY', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'button', _elm_lang$core$Json_Decode$int));
var _user$project$ImageCrop$onMouseDown = function (msg) {
	return A3(
		_elm_lang$html$Html_Events$onWithOptions,
		'mousedown',
		{stopPropagation: true, preventDefault: true},
...
var _user$project$ImageCrop$SelectAt = function (a) {
	return {ctor: 'SelectAt', _0: a};
};
...
var _user$project$ImageCrop$ResizeEnd = function (a) {
	return {ctor: 'ResizeEnd', _0: a};
};
var _user$project$ImageCrop$ResizeAt = function (a) {
	return {ctor: 'ResizeAt', _0: a};
};
var _user$project$ImageCrop$ResizeStart = F2(
	function (a, b) {
		return {ctor: 'ResizeStart', _0: a, _1: b};
	});
var _user$project$ImageCrop$MoveEnd = function (a) {
	return {ctor: 'MoveEnd', _0: a};
};
var _user$project$ImageCrop$MoveAt = function (a) {
...
var _user$project$ImageCrop$createSelection = F3(
	function (select, model, position) {
		if (_elm_lang$core$Native_Utils.eq(select.start, position)) {
			return _elm_lang$core$Maybe$Nothing;
		} else {
			...
			return _elm_lang$core$Maybe$Just(selection);
		}
	});
	...
	function (image, aspectRatio, selection) {
		...
		var height = _elm_lang$core$Basics$round(
			_elm_lang$core$Basics$sqrt(
				_elm_lang$core$Basics$toFloat(area) / (aspectRatio.width / aspectRatio.height)));
		var width = _elm_lang$core$Basics$round(
			_elm_lang$core$Basics$sqrt(
				_elm_lang$core$Basics$toFloat(area) * (aspectRatio.width / aspectRatio.height)));
		var newBottomRight = {x: topLeft.x + width, y: topLeft.y + height};
		return A5(_user$project$ImageCrop$createAspectRatioSelection, image, aspectRatio, _user$project$ImageCrop$DiagonalDirection, topLeft, newBottomRight);
	});
			...
			if (_p12.ctor === 'Just') {
				...
				if (_p13.ctor === 'Just') {
					...
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							selection: _elm_lang$core$Maybe$Just(newSelection)
						});
				} else {
					return model;
				}
...
var _user$project$ImageCrop$VerticalDirection = {ctor: 'VerticalDirection'};
var _user$project$ImageCrop$HorizontalDirection = {ctor: 'HorizontalDirection'};
var _user$project$ImageCrop$PositionLeft = {ctor: 'PositionLeft'};
var _user$project$ImageCrop$PositionBottom = {ctor: 'PositionBottom'};
var _user$project$ImageCrop$PositionRight = {ctor: 'PositionRight'};
var _user$project$ImageCrop$PositionTop = {ctor: 'PositionTop'};
...
var _user$project$ImageCrop$positionCssHelper = function (position) {
	...
	switch (_p14.ctor) {
		...
		case 'PositionRight':
			return {ctor: '_Tuple2', _0: 'right', _1: _user$project$ImageCrop$Vertical};
		case 'PositionBottom':
			return {ctor: '_Tuple2', _0: 'bottom', _1: _user$project$ImageCrop$Horizontal};
		default:
			return {ctor: '_Tuple2', _0: 'left', _1: _user$project$ImageCrop$Vertical};
	}
};
var _user$project$ImageCrop$border = function (position) {
			...
			_0: _elm_lang$html$Html_Attributes$style(
				{
					...
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: cssPosition, _1: '-1px'},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'width',
								_1: _elm_lang$core$Native_Utils.eq(orientation, _user$project$ImageCrop$Horizontal) ? '100%' : '1px'
							},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 'height',
									_1: _elm_lang$core$Native_Utils.eq(orientation, _user$project$ImageCrop$Vertical) ? '100%' : '1px'
								},
								_1: {
									ctor: '::',
...
var _user$project$ImageCrop$borders = A2(
	_elm_lang$core$List$map,
	_user$project$ImageCrop$border,
	{
		ctor: '::',
		_0: _user$project$ImageCrop$PositionTop,
		_1: {
			ctor: '::',
			_0: _user$project$ImageCrop$PositionRight,
			_1: {
				ctor: '::',
				_0: _user$project$ImageCrop$PositionBottom,
				_1: {
					ctor: '::',
					_0: _user$project$ImageCrop$PositionLeft,
					_1: {ctor: '[]'}
				}
			}
		}
	});
var _user$project$ImageCrop$NorthWest = {ctor: 'NorthWest'};
var _user$project$ImageCrop$West = {ctor: 'West'};
var _user$project$ImageCrop$SouthWest = {ctor: 'SouthWest'};
var _user$project$ImageCrop$South = {ctor: 'South'};
var _user$project$ImageCrop$SouthEast = {ctor: 'SouthEast'};
var _user$project$ImageCrop$East = {ctor: 'East'};
var _user$project$ImageCrop$NorthEast = {ctor: 'NorthEast'};
var _user$project$ImageCrop$North = {ctor: 'North'};
var _user$project$ImageCrop$generalizeDirection = function (direction) {
	return A2(
		...
		}) ? _user$project$ImageCrop$HorizontalDirection : (A2(
		_elm_lang$core$List$member,
		direction,
		{
			ctor: '::',
...
var _user$project$ImageCrop$calculateAnchor = function (_p16) {
	...
	var anchorY = A2(
		...
		_elm_lang$core$Basics$toFloat(topLeft.y + bottomRight.y) / 2) : bottomRight.y);
	return A2(_user$project$ImageCrop$Point, anchorX, anchorY);
};
var _user$project$ImageCrop$resizeSelection = F3(
	function (model, resize, position) {
		...
		if (_p21.ctor === 'Just') {
			...
			var secondY = _elm_lang$core$Native_Utils.eq(resize.direction, _user$project$ImageCrop$East) ? bottomRight.y : (_elm_lang$core$Native_Utils.eq(resize.direction, _user$project$ImageCrop$West) ? topLeft.y : normalizedPosition.y);
			var secondX = _elm_lang$core$Native_Utils.eq(resize.direction, _user$project$ImageCrop$South) ? bottomRight.x : (_elm_lang$core$Native_Utils.eq(resize.direction, _user$project$ImageCrop$North) ? topLeft.x : normalizedPosition.x);
			var second = A2(_user$project$ImageCrop$Point, secondX, secondY);
			var firstY = A2(
				_elm_lang$core$List$member,
				resize.direction,
				{
			...
			var first = A2(_user$project$ImageCrop$Point, firstX, firstY);
			return A3(_user$project$ImageCrop$normalizeEdges, model.image, first, second);
		}
	});
...
var _user$project$ImageCrop$handle = function (orientation) {
	...
	var _p33 = A2(
		...
		}) ? {ctor: '_Tuple2', _0: 'top', _1: '50%'} : {ctor: '_Tuple2', _0: 'bottom', _1: '0'});
	var verticalPosition = _p33._0;
	var verticalSpacing = _p33._1;
	var _p34 = A2(
		_elm_lang$core$List$member,
		orientation,
		{
		...
		}) ? {ctor: '_Tuple2', _0: 'left', _1: '50%'} : {ctor: '_Tuple2', _0: 'right', _1: '0'});
	var horizontalPosition = _p34._0;
	var horizontalSpacing = _p34._1;
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _user$project$ImageCrop$onMouseDown(
...
var _user$project$ImageCrop$handles = A2(
	_elm_lang$core$List$map,
	_user$project$ImageCrop$handle,
	{
		ctor: '::',
		_0: _user$project$ImageCrop$NorthWest,
		_1: {
...
var _user$project$ImageCrop$selectionView = F2(
	function (model, cropArea) {
		var _p35 = model.selection;
		if (_p35.ctor === 'Just') {
			var factor = _elm_lang$core$Basics$toFloat(model.cropAreaWidth) / _elm_lang$core$Basics$toFloat(model.image.width);
			var displaySelection = A2(_user$project$ImageCrop$scaleRectangle, factor, _p35._0);
			return {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					{
						ctor: '::',
						_0: _user$project$ImageCrop$selectionStyle(displaySelection),
						_1: {
							ctor: '::',
...
var _user$project$ImageCrop$view = function (model) {
	var cropArea = A2(_user$project$ImageCrop$calculateCropArea, model.image, model.cropAreaWidth);
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
	...
	var output = function () {
		...
		if (_p0.ctor === 'Just') {
			...
			return A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(_p1.topLeft.x),
					A2(
						_elm_lang$core$Basics_ops['++'],
						'|',
						A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(_p1.topLeft.y),
							A2(
								_elm_lang$core$Basics_ops['++'],
								'), (',
								A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Basics$toString(_p1.bottomRight.x),
									A2(
										_elm_lang$core$Basics_ops['++'],
										'|',
										A2(
											_elm_lang$core$Basics_ops['++'],
											_elm_lang$core$Basics$toString(_p1.bottomRight.y),
											')'))))))));
		} else {
			return 'No selection';
		}
	...
	return A2(
		_elm_lang$html$Html$img,
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$height(size.height),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$style(
							{
...
var _user$project$Main$viewportChanged = _elm_lang$core$Native_Platform.incomingPort('viewportChanged', _elm_lang$core$Json_Decode$int);
var _user$project$Main$requestOffset = _elm_lang$core$Native_Platform.outgoingPort(
	'requestOffset',
	function (v) {
		return null;
	});
var _user$project$Main$receiveOffset = _elm_lang$core$Native_Platform.incomingPort(
	'receiveOffset',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (x) {
...
var _user$project$Main$Viewport = function (a) {
	return {width: a};
};
...
var _user$project$Main$Initializing = function (a) {
	return {ctor: 'Initializing', _0: a};
};
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: _user$project$Main$Initializing(
		...
		switch (_p2.ctor) {
			case 'ImageCropMsg':
				...
				if (_p3.ctor === 'Initializing') {
					...
					var newModel = _p4._0;
					var newCmd = _p4._1;
					var notification = _p4._2;
					var appCmd = function () {
						var _p5 = notification;
						if (_p5.ctor === 'RequestOffset') {
							return _user$project$Main$requestOffset(
								{ctor: '_Tuple0'});
						} else {
					...
					return {
						...
						_1: _elm_lang$core$Platform_Cmd$batch(
							{
								ctor: '::',
								_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$ImageCropMsg, newCmd),
								_1: {
									ctor: '::',
									_0: appCmd,
									_1: {ctor: '[]'}
			...
			case 'ReceiveOffset':
				...
				if (_p8.ctor === 'Initializing') {
					...
					return {
						ctor: '_Tuple2',
						_0: _user$project$Main$Running(
							A2(_user$project$ImageCrop$receiveOffset, _p2._0, _p8._0)),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			default:
				...
				if (_p9.ctor === 'Initializing') {
					...
					var aspectRatio = _elm_lang$core$Native_Utils.eq(_p10, 'free') ? _elm_lang$core$Maybe$Nothing : (_elm_lang$core$Native_Utils.eq(_p10, 'square') ? _elm_lang$core$Maybe$Just(
						{width: 1, height: 1}) : (_elm_lang$core$Native_Utils.eq(_p10, 'din-landscape') ? _elm_lang$core$Maybe$Just(
						{
							width: _elm_lang$core$Basics$sqrt(2),
							height: 1
						}) : (_elm_lang$core$Native_Utils.eq(_p10, 'din-portrait') ? _elm_lang$core$Maybe$Just(
						{
							width: 1,
							height: _elm_lang$core$Basics$sqrt(2)
						}) : _elm_lang$core$Maybe$Nothing)));
					var newModel = A2(_user$project$ImageCrop$changeAspectRatio, aspectRatio, _p9._0);
					return {
						ctor: '_Tuple2',
						_0: _user$project$Main$Running(newModel),
						_1: _elm_lang$core$Platform_Cmd$none
	...
	var imageCropSubs = function () {
		...
		if (_p11.ctor === 'Initializing') {
			...
			return A2(
				...
				_user$project$ImageCrop$subscriptions(_p11._0));
		}
	}();
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Main$viewportChanged(_user$project$Main$ViewportChanged),
			_1: {
				ctor: '::',
				_0: _user$project$Main$receiveOffset(_user$project$Main$ReceiveOffset),
				_1: {
					ctor: '::',
					_0: imageCropSubs,
					_1: {ctor: '[]'}
...
var _user$project$Main$view = function (model) {
	var controls = function () {
		var _p12 = model;
		if (_p12.ctor === 'Initializing') {
			return {ctor: '[]'};
		} else {
			return {
				ctor: '::',
				_0: _user$project$Main$rectangle(_p12._0.selection),
				_1: {
					ctor: '::',
					_0: A2(
	...
	var imageCrop = function () {
		var _p13 = model;
		if (_p13.ctor === 'Initializing') {
			return {
				ctor: '::',
				_0: _user$project$Main$demoImage(_p13._0),
				_1: {ctor: '[]'}
			};
		} else {
			var _p14 = _p13._0;
			return {
				ctor: '::',
				_0: _user$project$Main$demoImage(_p14.image),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$map,
						_user$project$Main$ImageCropMsg,
						_user$project$ImageCrop$view(_p14)),
					_1: {ctor: '[]'}
				}
			};
		}
