...
var _user$project$ImageCrop_Interop$init = function (_p0) {
	var _p1 = _p0;
	return {
		ctor: '_Tuple2',
...
var _user$project$ImageCrop_Interop$selectionChanged = _elm_lang$core$Native_Platform.outgoingPort(
	'selectionChanged',
	function (v) {
...
var _user$project$ImageCrop_Interop$changeAspectRatio = _elm_lang$core$Native_Platform.incomingPort(
	'changeAspectRatio',
...
var _user$project$ImageCrop_Interop$view = function (model) {
	return A2(
		...
		_user$project$ImageCrop_Interop$ImageCropMsg,
		_user$project$ImageCrop$view(model));
};
...
var _user$project$ImageCrop_Interop$subscriptions = function (model) {
	var imageCropSubs = A2(
		_elm_lang$core$Platform_Sub$map,
		_user$project$ImageCrop_Interop$ImageCropMsg,
		_user$project$ImageCrop$subscriptions(model));
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
...
var _user$project$ImageCrop_Interop$main = _elm_lang$html$Html$programWithFlags(
	{init: _user$project$ImageCrop_Interop$init, view: _user$project$ImageCrop_Interop$view, update: _user$project$ImageCrop_Interop$update, subscriptions: _user$project$ImageCrop_Interop$subscriptions})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (aspectRatio) {
			return A2(
				_elm_lang$core$Json_Decode$andThen,
				function (cropAreaWidth) {
					return A2(
						_elm_lang$core$Json_Decode$andThen,
						function (image) {
							return A2(
				...
				A2(_elm_lang$core$Json_Decode$field, 'cropAreaWidth', _elm_lang$core$Json_Decode$int));
		},
		A2(
			_elm_lang$core$Json_Decode$field,
			'aspectRatio',
